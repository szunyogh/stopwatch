...
int get hashCode {
  final _this = this as LapModel;
  return Object.hash(runtimeType,_this.time,_this.totalTime,_this.order);
}

@override
String toString() {
  final _this = this as LapModel;
  return 'LapModel(time: ${_this.time}, totalTime: ${_this.totalTime}, order: ${_this.order})';
}
...
/// @nodoc
class _$LapModelCopyWithImpl<$Res>
...
/// Create a copy of LapModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? time = null,Object? totalTime = null,Object? order = null,}) {
  return _then(LapModel(
time: null == time ? _self.time : time // ignore: cast_nullable_to_non_nullable
as Duration,totalTime: null == totalTime ? _self.totalTime : totalTime // ignore: cast_nullable_to_non_nullable
as Duration,order: null == order ? _self.order : order // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LapModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LapModel value)  $default,){
final _that = this;
switch (_that) {
case _LapModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LapModel value)?  $default,){
final _that = this;
switch (_that) {
case _LapModel() when $default != null:
return $default(_that);case _:
...
/// @nodoc
abstract mixin class _$LapModelCopyWith<$Res> implements $LapModelCopyWith<$Res> {
...
/// @nodoc
class __$LapModelCopyWithImpl<$Res>
    implements _$LapModelCopyWith<$Res> {
...
/// Create a copy of LapModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? time = null,Object? totalTime = null,Object? order = null,}) {
